...
<div class="img-hover-zoom">
    <img src="${data[0].img}" class="img-fluid rounded">
</div>
<h5>${data[0].category}</h5>
<a href=${data[0].slug}><h1>${data[0].title}</h1></a>
<p>${data[0].desc}</p>
<div class="d-flex authorDetails">
<img src="./images/blog/profile.jpeg" class="img-fluid rounded-circle img-thumbnail">
<h3>Akhil S Kumar</h3>
<h3>${data[0].date}</h3>
</div>
        `;
...
const oldPost = data.slice(3).map((oldPost, i) => {
  return `
    <div class="col-lg-6 oldPosts">
        <div class="img-hover-zoom">
            <img src="${oldPost.img}" class="img-fluid rounded">
        </div>
